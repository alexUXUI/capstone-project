exports.seed = function(knex, Promise) {
    return Promise.all([
      knex('users').insert({
        ...
        personal_info: 'I am user1 and I love political art in CO'
      }),
      knex('users').insert({
        ...
        personal_info: 'I am user2 and I love political art in CA'
      }),
      knex('users').insert({
        ...
        personal_info: 'I am user3 and I love political art in Delware'
      }),
      knex('users').insert({
        email: 'user1@gmail.com',
        username: 'Elana',
        ...
        personal_info: 'I am user4 and I love political art in Brasil'
      }),
      knex('users').insert({
        email: 'user2@gmail.com',
        username: 'Anna',
        ...
        personal_info: 'I am user5 and I love political art in England'
      }),
      knex('users').insert({
        email: 'user3@gmail.com',
        username: 'Danny',
        ...
        personal_info: 'I am user6 I love political art in Germany'
      }),
      knex('users').insert({
        email: 'user1@gmail.com',
        username: 'Brian',
        ...
        personal_info: 'I am user7 I love political art in France'
      }),
      knex('users').insert({
        email: 'user2@gmail.com',
        username: 'Kyle',
        ...
        personal_info: 'I am user8 andI love political art in Kenya'
      }),
      knex('users').insert({
        email: 'user3@gmail.com',
        username: 'Chris',
        ...
        personal_info: 'I am user9 andI love political art in Egypt'
      }),
      knex('users').insert({
        email: 'user1@gmail.com',
        username: 'Brooke',
        ...
        personal_info: 'I am user10 and I love political art in Syria'
      }),
      knex('users').insert({
        email: 'user2@gmail.com',
        ...
        personal_info: 'I am user11 and I love political art in Iraq'
      }),
      knex('users').insert({
        email: 'user3@gmail.com',
        username: 'Steve',
        ...
        personal_info: 'I am user12 and I love political art in China'
      }),
      knex('users').insert({
        email: 'user3@gmail.com',
        username: 'Ben',
        ...
        personal_info: 'I am user13 and I love political art in Russia'
      }),
      knex('users').insert({
        email: 'user1@gmail.com',
        username: 'Justin',
        ...
        personal_info: 'I am user14 and I love political art in Greece'
      }),
      knex('users').insert({
        email: 'user2@gmail.com',
        username: 'Isaac',
        ...
        personal_info: 'I am user15 and  I love political art in Japan'
      }),
      knex('users').insert({
        email: 'user3@gmail.com',
        username: 'Josh',
        ...
        personal_info: 'I am user16 and I love political art in Canada'
      })
    ]);
  };
